...
(function ($) {
  ...
  $container.append(
    '<h5>Tủy Chỉnh Admin</h5><hr class="mb-2"/>'
  )
  ...
  var $dark_mode_container = $('<div />', { class: 'mb-4' }).append($dark_mode_checkbox).append('<span>Chế Độ Ban Đêm</span>')
  $container.append($dark_mode_container)

  $container.append('<h6>Tùy chỉnh Tiêu Đề</h6>')
  ...
  $container.append('<h6>Tùy chỉnh Thanh Công Cụ </h6>')
  ...
  $container.append('<h6>Tùy chỉnh Footer</h6>')
  ...
  $container.append('<h6>Tùy chỉnh Văn Bản nhỏ </h6>')
